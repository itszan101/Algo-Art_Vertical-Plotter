...
#define PEN_DOWN_ANGLE  (15.0)  // Some servos don't like 0 degrees
#define PEN_DELAY       (800)  // in ms
...
#define MAX_STEPS_S     (STEPS_PER_TURN*MAX_RPM/500.0)  // steps/s

#define MAX_FEEDRATE    (2000.0)
#define MIN_FEEDRATE    (5.0) // steps / second
